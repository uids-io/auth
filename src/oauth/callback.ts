...
export async function startSocialLogin(
  ...
  if (provider === 'google') {
    ...
    if (!google) {
      throw new UnauthorizedError('Google provider not configured', 'provider_not_configured');
    }
  ...
  if (!microsoft) {
    throw new UnauthorizedError('Microsoft provider not configured', 'provider_not_configured');
  }
